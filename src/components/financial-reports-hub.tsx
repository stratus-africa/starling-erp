...
const config: ReportsListingConfig = {
  ...
  reports: [
    {
      ...
      description:
        "Full transaction-level view of every posted journal entry with account, source, and running balance detail.",
    ...
    },
    {
      id: "trial-balance",
      title: "Trial Balance",
      description: "Aggregated debit and credit balances for every account at a selected date.",
    ...
    },
    {
      ...
      title: "Profit & Loss",
      description:
        "Revenue, cost of goods sold, operating expenses, and net profit for a selected period.",
    ...
    },
    {
      ...
      title: "Balance Sheet",
      description:
        "Point-in-time snapshot of assets, liabilities, equity, and current year profit.",
    ...
    },
    {
      ...
      title: "VAT Report",
      description:
        "Output VAT, input VAT, and net VAT payable from posted VAT control account entries.",
  ...
  reportingInformation:
    "Reports are generated from posted transactions and update as transactions are posted. Draft transactions do not affect financial figures.",
  accent: "blue",
  currencyKpis: true,
};

export function FinancialReportsHub() {
  return <ReportsListingPage config={config} />;
}
