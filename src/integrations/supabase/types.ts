  ...
  public: {
    ...
    Functions: {
      ...
      validate_posting_journals: {
        Args: { _entity_id: string; _entity_type: string; _require_journal?: boolean };
        Returns: number;
      };
      ...
      set_item_opening_stock: {
        Args: { _item_id: string; _quantity: number; _unit_cost?: number; _warehouse_id?: string | null };
        Returns: string;
      };
      global_search: {
        Args: {
      ...
      void_posted_document: {
        Args: { _entity_type: string; _entity_id: string; _permission: string; _reason?: string };
        Returns: string;
      };
