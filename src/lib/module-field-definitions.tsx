...
export const itemFields: FieldDef[] = [
  ...
  // ── Units of Measure ─────────────────────────────────────────────────────
  // Options are loaded from the `units_of_measure` DB table at runtime.
  // The static list here is a display-only fallback for the DataModulePage
  // list view. Item360Page uses live useFkOptions for full UOM picker support.
  {
    key: "uom",
    label: "Stock UoM",
    type: "select",
