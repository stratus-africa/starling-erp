...
import {
  Building2, Users, Layers, Globe, Percent, CreditCard, Hash,
  Mail, Bell, KeyRound, Warehouse, Ruler, Workflow, FileText,
  ShoppingCart, Package, Boxes, ShoppingBag, Coins, Receipt,
  Settings, BookText, Scale, Landmark,
} from "lucide-react";
...
const SECTIONS: SettingSection[] = [
  {
    ...
    groups: [
      ...
      },
      {
        ...
        links: [
          { label: "API Keys",           url: "/settings/api-keys" },
        ],
      },
    ],
  },
...
export function SettingsHubPage() {
  return (
    <div className="flex flex-col gap-10 p-6 md:p-8 max-w-6xl">

      {SECTIONS.map((section) => (
        <section key={section.heading}>

          {/* Section heading */}
          <h2 className="text-base font-semibold tracking-tight mb-4 text-foreground">
            {section.heading}
          </h2>
