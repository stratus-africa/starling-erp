...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      cancel_reservation: {
        Args: { _reservation_id: string; _notes?: string };
        Returns: boolean;
      };
      ...
      fulfill_document_reservations: {
        Args: { _document_id: string; _document_type: string; _notes?: string };
        Returns: number;
      };
      fulfill_reservation: {
        Args: { _reservation_id: string; _notes?: string };
      ...
      generate_doc_number: {
        Args: { _tenant_id: string; _prefix: string; _pad_width?: number };
        Returns: string;
      };
      get_item_availability: {
        Args: { _item_id: string; _warehouse_id?: string };
        Returns: {
          available: number;
          item_id: string;
          on_hand: number;
