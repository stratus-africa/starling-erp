...
export function CompanyBrandingCard({ data, onChange, tenantId, disabled }: Props) {
  ...
  const handleFileUpload = async (file: File, field: "logo_url" | "signature_url" | "stamp_url") => {
    if (!file) return;
    if (!tenantId) {
        ...
        <CardHeader className="pb-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <CardDescription>
                Primary graphic identity used across navigation, topbar, quotes, and customer statements.
              </CardDescription>
            </div>
          </div>
        </CardHeader>
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 p-4 rounded-lg border bg-muted/20">
            ...
            <div className="flex-1 space-y-2">
              <p className="text-xs text-muted-foreground">
                Recommended dimensions: 300 × 100 pixels. Supported formats: PNG, JPG, WebP, SVG. Transparent background recommended. Maximum size: 2MB.
              </p>
          ...
          <CardHeader className="pb-4">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <CardDescription>
                  Digital signature placed on approved delivery notes, contracts, and payment receipts.
                </CardDescription>
              </div>
            </div>
          </CardHeader>
              ...
              <div className="space-y-1">
                ...
                <div className="flex gap-2">
                  <Button
                    ...
                    disabled={disabled || uploadingField === "signature_url"}
                  >
                    {uploadingField === "signature_url" ? <Loader2 className="h-3 w-3 animate-spin" /> : "Upload"}
                  </Button>
                  {data.signature_url && (
                    <Button
                      type="button"
              ...
              <div className="space-y-1">
                ...
                <div className="flex gap-2">
                  <Button
                    ...
                    disabled={disabled || uploadingField === "stamp_url"}
                  >
                    {uploadingField === "stamp_url" ? <Loader2 className="h-3 w-3 animate-spin" /> : "Upload"}
                  </Button>
                  {data.stamp_url && (
                    <Button
                      type="button"
