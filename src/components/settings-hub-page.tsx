    ...
    groups: [
      {
        ...
        links: [
          ...
          { label: "Integrity Checks", url: "/accounting/integrity" },
          { label: "Audit Trail", url: "/accounting/audit-trail" },
        ],
      },
      {
        title: "Banking",
    ...
    <div className="flex flex-col gap-10 p-6 md:p-8">
      {SECTIONS.map((section) => (
        <section key={section.heading}>
          ...
          {/* Cards — auto-fill so they always stretch to fill the full row */}
