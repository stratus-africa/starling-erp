-- item_lots and item_serials are created authoritatively by
-- 20260906200000_batch_lot_serial_traceability.sql. Keep this workflow
-- migration focused on production-order behavior so clean replay cannot hide
-- drift behind a second CREATE TABLE definition.
